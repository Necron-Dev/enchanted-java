  ...
  public static byte[] enchant(byte[] original, ClassLoader classLoader, Map<String, ?> properties) {
    ...
    try {
      List.of(
        ...
        TrimDefaultPass.Instance,
        SingleDollarPass.Instance,
        ReceiverPass.Instance,
        DoubleUnderscorePass.Instance,
        DesugarDoubleDollarPass.Instance,
        ElvisPass.Instance,
        DesugarSingleDollarPass.Instance,
        SafePass.Instance,
        PassCastUnpurePass.Instance,
